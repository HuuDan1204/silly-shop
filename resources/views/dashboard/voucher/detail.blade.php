            ...
            <div class="card-body">
                ...
                <div class="d-flex gap-2 justify-content">
                    ...
                    <button type="button" class="btn btn-secondary mt-3" data-bs-toggle="modal" id="create-btn"
                        ...
                        {{-- <form action="{{route('dashboard.voucher.delete',$data_voucher->id)}}" method="post">
                            @csrf
                            <button class="btn btn-danger mt-3">Xóa</button>
                        </form> --}}
                        <form action="{{route('dashboard.voucher.restore',$data_voucher->id)}}" method="post">
                            @csrf
                                        ...
                                        @endif>
                                            ...
                                            @foreach ($categories as $render_name)
                                                <option value="{{ $render_name->id }}"
                                                    {{ $data_voucher->cate_voucher->id == $render_name->id ? 'selected' : '' }}>
                                                    {{ $render_name->name }}
                                                </option>
                                            @endforeach
                                        </select>
