                        ...
                        <div class="card-body">
                            <div class="mt-0">
                                <div class="d-flex flex-wrap">
                                    ...
                                    {{-- Nút sửa --}}
                                    <div class="ms-auto">
                                        <a href="{{ route('dashboard.products.edit', $product->id) }}" class="btn btn-light"
                                            title="Chỉnh sửa">
                                        ...
                                        <div class="row mb-5 border-bottom pb-4">
                                            ...
                                            <div class="col-xl-8">
                                                ...
                                                <div class="mt-2 d-flex align-items-center">
                                                    <a href="{{ route('dashboard.variants.edit', $variant->id) }}"
                                                        class="btn btn-sm btn-primary me-2">Chỉnh sửa</a>
                                                    <a href="{{ route('dashboard.variants.show', $variant->id) }}"
                                                        class="btn btn-sm btn-secondary me-2">Xem chi tiết</a>
                                                    @if ($variant->use_flash_sale == 0)
                                                        {{-- <form action="{{ route('dashboard.addflashsale', $variant->id) }}"
